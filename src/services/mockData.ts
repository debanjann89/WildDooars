...
export const initialHotels: Hotel[] = [
  {
    id: 'stay-bamboo-forest-cottage',
    name: 'Handcrafted Bamboo Eco Cottage',
    propertyType: 'Cottage',
    badge: 'Signature Eco Stay',
    capacity: '2 - 4 Guests',
    bedType: 'Double Bed + Daybed',
    location: 'Forest Sanctuary Edge, Dooars',
    description: 'Experience authentic living nestled inside deep woodland. Features artisanal woven bamboo ceilings, handcrafted bamboo furniture, warm mood lighting, private veranda overlooking natural lily ponds, and modern ensuite bathroom with hot water geyser.',
    amenities: ['Artisanal Bamboo Architecture', 'Private Veranda Facing Pond', 'Modern Ensuite Bath with Geyser', 'Quiet Forest Setting', 'Electric Kettle & Tea Setup', '24/7 Power Backup', 'In-Room Dining Service', 'Evening Bonfire on Request'],
    image: '/images/hotels/bamboo_cottage_interior.jpg',
    gallery: [
      '/images/hotels/bamboo_cottage_interior.jpg',
      '/images/hotels/bamboo_cottage_night_pond.jpg',
      '/images/hotels/bamboo_cottage_day_garden.jpg',
      '/images/hotels/bamboo_cottage_illuminated_veranda.jpg',
      '/images/hotels/garden_cottages_row.jpg'
    ],
    isPublished: true
  },
  {
    id: 'stay-wooden-family-suite',
    name: 'Executive Wooden Family Suite',
    propertyType: 'Suite',
    badge: 'Spacious Family Choice',
    capacity: '3 - 5 Guests',
    bedType: 'King Bed + Single Bed',
    location: 'Garden Resort Sanctuary, Dooars',
    description: 'Designed specially for family comfort, this expansive suite features high wooden ceilings with warm recessed lighting, rich timber flooring, a master king bed plus single bed, cane lounge armchairs, wardrobe, split air conditioning, and a luxury marble-tiled bathroom.',
    amenities: ['Split Air Conditioning', 'King Bed + Single Bed', 'Natural Wood Ceiling & Flooring', 'Luxury Bathroom with Geyser', 'Cane Lounge Chairs & Coffee Table', 'Scenic Daylight Windows', 'High-Speed Wi-Fi', 'Daily Housekeeping'],
    image: '/images/hotels/family_suite_master.jpg',
    gallery: [
      '/images/hotels/family_suite_master.jpg',
      '/images/hotels/family_suite_cane_lounge.jpg',
      '/images/hotels/family_suite_panoramic.jpg',
      '/images/hotels/luxury_attached_bathroom.jpg',
      '/images/hotels/resort_villas_lawn.jpg'
    ],
    isPublished: true
  },
  {
    id: 'stay-deluxe-nature-room',
    name: 'Deluxe Nature View AC Room',
    propertyType: 'Deluxe Room',
    badge: 'Couples & Small Families',
    capacity: '2 - 3 Guests',
    bedType: 'Comfort Double Bed',
    location: 'River & Tea Garden Wing, Dooars',
    description: 'A serene nature retreat with large picture windows framing lush tea gardens and Dooars forest foothills. Features split air conditioning, handcrafted cane armchairs, elegant peacock wall artwork, ensuite modern washroom, and direct access to open riverfront view balconies.',
    amenities: ['Tea Garden & Forest View Window', 'Split Air Conditioning', 'Private Balcony Access', 'Ensuite Bathroom with Geyser', 'Cane Armchairs & Table', 'Flat Screen TV', 'In-Room Dining'],
    image: '/images/hotels/deluxe_nature_room.jpg',
    gallery: [
      '/images/hotels/deluxe_nature_room.jpg',
      '/images/hotels/nature_balcony_river_view.jpg',
      '/images/hotels/luxury_attached_bathroom.jpg',
      '/images/hotels/resort_pathway_walk.jpg'
    ],
    isPublished: true
  },
  {
    id: 'stay-executive-double-room',
    name: 'Contemporary Executive Double Room',
    propertyType: 'Executive Room',
    badge: 'Modern Elegance',
    capacity: '2 Guests',
    bedType: 'Queen Double Bed',
    location: 'Main Courtyard Wing, Dooars',
    description: 'Crisp contemporary styling tailored for modern travelers. Equipped with a plush double bed, bedside power controls, wall-mounted LED TV, executive work desk with ergonomic chair, split AC, and a sparkling tiled modern bathroom with instant hot water shower.',
    amenities: ['Wall-Mounted Smart LED TV', 'Executive Work Desk & Chair', 'Split Air Conditioning', 'Modern Attached Bath with Geyser', 'Free Wi-Fi', '24/7 Power Backup', 'Room Service'],
    image: '/images/hotels/executive_double_room.jpg',
    gallery: [
      '/images/hotels/executive_double_room.jpg',
      '/images/hotels/luxury_attached_bathroom.jpg',
      '/images/hotels/resort_main_fountain.jpg',
      '/images/hotels/resort_swimming_pool.jpg'
    ],
    isPublished: true
  },
  {
    id: 'stay-resort-grounds-experience',
    name: 'Resort Grounds & Recreation Facilities',
    propertyType: 'Resort Grounds',
    badge: 'Resort Experience',
    capacity: 'All Resident Guests',
    bedType: 'Outdoor & Leisure Amenities',
    location: 'Riverside & Foothills, Dooars',
    description: 'Complete resort infrastructure set across acres of lush wilderness. Features a sparkling outdoor swimming pool illuminated at night, vast manicured lawns for evening relaxation, multi-color musical water fountains, riverside panoramic viewing decks, and campfire zones.',
    amenities: ['Illuminated Swimming Pool', 'Vast Manicured Green Lawns', 'Musical Water Fountains at Dusk', 'River & Forest Panoramic Decks', 'Outdoor Gazebo & Stage', 'Scenic Paved Walkways', 'Children Play Area', 'Safe Private Parking'],
    image: '/images/hotels/resort_swimming_pool.jpg',
    gallery: [
      '/images/hotels/resort_swimming_pool.jpg',
      '/images/hotels/resort_aerial_dense_forest.jpg',
      '/images/hotels/resort_aerial_river_tea.jpg',
      '/images/hotels/resort_main_fountain.jpg',
      '/images/hotels/resort_sprawling_lawn.jpg',
      '/images/hotels/resort_statue_fountain.jpg'
    ],
    isPublished: true
  }
];
